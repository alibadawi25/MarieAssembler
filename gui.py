...
from Output_Mode import Output_Mode
...
def run_function(outputTextbox, app):
    ...
    marie_memory = test.marie_memory
    executeProgram(marie_memory, outputTextbox, app)


def option_changed(new_option):
    Output_Mode.output_mode = new_option
...
def main():
    ...
    inputTextbox = customtkinter.CTkTextbox(master=app, width=400, height=300, corner_radius=10, wrap="word", font=("Normal", 14))
